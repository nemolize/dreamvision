      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Colors & Gradients</h3>
            <p className="text-gray-600">Beautiful gradient backgrounds and color utilities</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">Built-in animation classes like pulse, bounce, etc.</p>
          </div>
        </div>

        {/* Interactive Elements */}
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Interactive Elements</h2>
          ...
          <div className="space-y-6">
            ...
            {/* Badges */}
            <div>
              <h3 className="text-lg font-semibold text-gray-700 mb-3">Badges</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Layout Examples</h2>
          
          {/* Flexbox Example */}
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-gray-700 mb-3">Flexbox Layout</h3>
          ...
          {/* Grid Example */}
          <div>
            <h3 className="text-lg font-semibold text-gray-700 mb-3">Grid Layout</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
                <div key={item} className="bg-gray-200 p-4 rounded-lg text-center">
